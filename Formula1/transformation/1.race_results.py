...
results_df = spark.read.parquet(f"{silver_folder_path}/results").withColumnRenamed("time","race_time")
...
race_circuits_df = races_df.join(circuits_df, races_df.circuit_id == circuits_df.circuit_id).select(races_df.race_id, races_df.race_year, races_df.race_name, races_df.race_date, circuits_df.circuit_location)
...
race_results_df = results_df.join(race_circuits_df, results_df.race_id == race_circuits_df.race_id)\
                            ...
                            .join(contrustor_df, results_df.constructor_id == contrustor_df.constructor_id)
